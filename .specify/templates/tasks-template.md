...
**Tests**: The examples below include test tasks. Tests are MANDATORY per Constitution Principle II. Include unit and integration tests for all features.
...
- [ ] T018 [US1] **TEST VERIFICATION**: Execute all User Story 1 tests and verify 100% pass rate (Constitution Principle II)
...
- [ ] T025 [US2] **TEST VERIFICATION**: Execute all User Story 2 tests and verify 100% pass rate (Constitution Principle II)
...
- [ ] T031 [US3] **TEST VERIFICATION**: Execute all User Story 3 tests and verify 100% pass rate (Constitution Principle II)
...
- [ ] TXXX **FINAL TEST VERIFICATION**: Execute complete test suite across all features and verify 100% pass rate (Constitution Principle II)
